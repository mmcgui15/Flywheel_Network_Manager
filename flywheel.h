...
struct rotor_material {
    ...
    friend std::istream& operator >>(std::istream& is, rotor_material& rm);
    friend std::ostream& operator <<(std::ostream& os, rotor_material& rm);
};
...
class flywheel {
    ...
    public:
        ...
        flywheel(char name[64], shape rs, double r, double l, double m, double i_c, double a_v, rotor_material r_ms);
    private:
        ...
        friend std::istream& operator >>(std::istream& is, flywheel& fw);
        friend std::ostream& operator <<(std::ostream& os, flywheel& fw);
    };
